    ...
    Partial Public Class ProductosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Productos] WHERE (([IdProducto] = @Original_IdProducto) AND (("& _ 
                ...
                "l_Descripcion)) AND ((@IsNull_BajaLogica = 1 AND [BajaLogica] IS NULL) OR ([Baja"& _ 
                "Logica] = @Original_BajaLogica)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Productos] ([Nombre], [Descripcion], [BajaLogica]) VALUES (@No"& _ 
                "mbre, @Descripcion, @BajaLogica);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT IdProducto, Nombre, Descripcion, BajaL"& _ 
                "ogica FROM Productos WHERE (IdProducto = SCOPE_IDENTITY())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Productos] SET [Nombre] = @Nombre, [Descripcion] = @Descripcion, [B"& _ 
                "ajaLogica] = @BajaLogica WHERE (([IdProducto] = @Original_IdProducto) AND ((@IsN"& _ 
                ...
                "scripcion)) AND ((@IsNull_BajaLogica = 1 AND [BajaLogica] IS NULL) OR ([BajaLogi"& _ 
                "ca] = @Original_BajaLogica)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT IdProducto, Nombre, Descripcion, BajaLogi"& _ 
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT IdProducto, Nombre, Descripcion, BajaLogica FROM dbo.Productos"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSet2.ProductosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSet2.ProductosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DataSet2.ProductosDataTable = New DataSet2.ProductosDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DataSet2.ProductosDataTable) As Integer
